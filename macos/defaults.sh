...
sudo scutil --set ComputerName "TolersMacBook"
sudo scutil --set HostName "TolersMacBook"
sudo scutil --set LocalHostName "TolersMacBook"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "TolersMacBook"
